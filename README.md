...
| `BATCH.CHAIN.1` | **tamper-evident** custody chain (artifact + predecessor hashes) | tamper-proof · authenticity · authorization · batch correctness |
